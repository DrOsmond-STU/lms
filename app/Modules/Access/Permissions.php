...
final class Permissions
{
    ...
    public const ROLE_MAP = [
        ...
        'trainer' => [
            ...
            'report.view_class', 'report.export', 'calendar.view', 'announcement.*', 'gradebook.*', 'ai.*',
        ],
        'participant' => [
            ...
            'privacy_request.create', 'referral.view', 'calendar.view', 'announcement.view', 'gradebook.view', 'ai.use',
        ],
    ];
