...
> 📁 Folder ini berisi **purwarupa UI statis** yang dipakai sebagai acuan visual & alur untuk
> aplikasi produksi di root repositori. **Tidak di-deploy** ke produksi.
>
> ⚠️ Logika di `assets/js/*` tidak aman untuk produksi dan tidak boleh diporting — lihat
