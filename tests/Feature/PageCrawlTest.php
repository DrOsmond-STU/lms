...
it('opens every page reachable by a super admin without errors', function () {
    ...
    $result = crawl(['/admin', '/admin/pengaturan', '/admin/kelas', '/admin/pembayaran', '/admin/laporan/organisasi', '/admin/laporan/referral', '/akun/keamanan', '/notifikasi']);
...
it('opens every page reachable by a certified participant without errors', function () {
    ...
    $result = crawl(['/peserta', '/peserta/program', '/peserta/pembelajaran', '/peserta/sertifikat', '/peserta/transaksi', '/peserta/referral', '/notifikasi', '/akun/profil']);
