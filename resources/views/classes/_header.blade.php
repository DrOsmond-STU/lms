...
<nav class="tabs mb-6" aria-label="Bagian kelas">
    @foreach (['content' => ['classes.manage', 'Konten'], 'assessments' => ['classes.assessments', 'Asesmen'], 'sessions' => ['classes.sessions', 'Sesi & Presensi'], 'participants' => ['classes.participants', 'Peserta']] as $key => [$routeName, $label])
